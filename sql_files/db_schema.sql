...
ALTER COLUMN address TYPE varchar(225),
...
ALTER COLUMN product_category TYPE varchar(225);

--- Update dtype of order times table---
ALTER TABLE dim_date_times
ALTER COLUMN purchase_date TYPE date
USING purchase_date::date,
ALTER COLUMN purchase_time TYPE time
USING purchase_time:: time without time zone,
ALTER COLUMN date_uuid TYPE UUID
USING date_uuid::uuid;
...
ALTER COLUMN card_provider TYPE varchar(225);
