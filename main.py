...
if __name__ == "__main__":
    ...
    database_connector.upload_to_db(dcl.DataCleaner().clean_user_data(), "dim_users")
    database_connector.upload_to_db(dcl.DataCleaner().clean_card_data(), "dim_card_details")
